...
UPDATE prj_volume.clusters
SET (centreline_id, dir_bin) = (B.centreline_id, B.dir_bin)
FROM artery_tcl_directions B
WHERE clusters.arterycode = B.arterycode AND B.dir_bin IN (1,-1);