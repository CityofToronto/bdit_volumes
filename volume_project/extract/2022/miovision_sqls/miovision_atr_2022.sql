...
AS
 WITH mio_data AS (
         SELECT volumes.volume_15min_uid,
        ...
        WHERE volumes.datetime_bin >= '2022-01-01 00:00:00'::timestamp without time zone
            AND volumes.datetime_bin < '2023-01-01 00:00:00'::timestamp without time zone 
