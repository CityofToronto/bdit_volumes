...
INSERT INTO tmc_turns_temp(arterycode, movement, tcl_from_segment, tcl_to_segment)
SELECT	A.arterycode,
...
INSERT INTO prj_volume.tmc_turns(arterycode, movement, tcl_from_segment, tcl_to_segment)
SELECT A.arterycode, A.movement, A.tcl_from_segment, A.tcl_to_segment
